            ...
            <div class="card-body">
              <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <center><?=$contador_docentes;?></center>
                    </td>
                    <td>
                      <center><?=$docente['nombres']." ".$docente['apellidos']?></center>
                    </td>
                    <td>
                      <center><?=$docente['ci']?></center>
                    </td>
                    <td>
                      <center><?=$docente['fecha_nacimiento']?></center>
                    </td>
                    <td>
                      <center><?=$docente['email']?></center>
                    </td>
                    <td>
                      <center>
                        <?php
                    ...
                    <td>
                      <center>
                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                          data-target="#modal_materias<?=$id_docente;?>">
                          <i class="bi bi-postcard"></i> Ver materias
                        </button>
                      </center>
                      <div class="modal fade" id="modal_materias<?=$id_docente;?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <hr>
                              <table class="table table-bordered table-striped table-sm table-hovers">
                                ...
                                <?php
                                            $contador = 0;
                                            foreach ($asignaciones as $asignacione){ $contador = $contador +1;
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                      ...
                                      <div class="modal fade" id="modal_edicion<?=$id_asignacion;?>" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            <div class="modal-header" style="background-color: #0fbf0c;">
                                              <h5 class="modal-title" id="exampleModalLabel"><b>Actualizar asignacion de
                                                  materias</b></h5>
                                            ...
                                            <div class="modal-body">
                                              <form
                                                action="<?=APP_URL;?>/app/controllers/docentes/update_asignacion.php"
                                                method="post">
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    <div class="form-group">
                                                      <input type="text" name="id_asignacion"
                                                        value="<?=$id_asignacion;?>" hidden>
                                                      ...
                                                      <select name="id_nivel" id="" class="form-control">
                                                        ...
                                                        <option value="<?=$id_nivel?>"
                                                          <?=$nivele['id_nivel']==$asignacione['nivel_id'] ? 'selected' : ''?>>
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <select name="id_grado" id="" class="form-control">
                                                        ...
                                                        <option value="<?=$id_grado?>"
                                                          <?=$grado['id_grado']==$asignacione['grado_id'] ? 'selected' : ''?>>
                                                          <?=$grado['curso']." - SECCIÓN - ".$grado['seccion'];?>
                                                        </option>
                                                        <?php
                                                                                                }
                                                                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <select name="id_materia" id="" class="form-control">
                                                        ...
                                                        <option value="<?=$id_materia?>"
                                                          <?=$materia['id_materia']==$asignacione['materia_id'] ? 'selected' : ''?>>
                                      ...
                                      <form action="<?=APP_URL;?>/app/controllers/docentes/delete_asignacion.php"
                                        onclick="preguntar<?=$id_asignacion;?>(event)" method="post"
                                        id="miformulario<?=$id_asignacion;?>">
                                        <input type="text" name="id_asignacion" value="<?=$id_asignacion;?>" hidden>
                                        <button type="submit" class="btn btn-danger btn-sm"
                                          style="border-radius: 0px 4px 4px 0px;"><i class="bi bi-trash"></i></button>
                                      </form>
                                      <script>
...
$(function() {
  $("#example1").DataTable({
    ...
    "language": {
      ...
      "infoPostFix": "",
      "thousands": ",",
      "lengthMenu": "Mostra _MENU_ Docentes",
