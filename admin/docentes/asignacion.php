              ...
              <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                ...
                <tbody>
                  ...
                  foreach ($docentes as $docente){
                      ...
                      <tr>
                        <td><center><?=$contador_docentes;?></center></td>
                        <td><center><?=$docente['nombres']." ".$docente['apellidos']?></center></td>
                        <td><center><?=$docente['ci']?></center></td>
                        <td><center><?=$docente['fecha_nacimiento']?></center></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                                ...
                                                                <div class="modal fade" id="modal_edicion<?=$id_asignacion;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header" style="background-color: #0fbf0c;">
                                                                            <h5 class="modal-title" id="exampleModalLabel"><b>Actualizar asignacion de materias</b></h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <form action="<?=APP_URL;?>/app/controllers/docentes/update_asignacion.php" method="post">
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select name="id_grado" id="" class="form-control">
                                                                                                ...
                                                                                                foreach ($grados as $grado){
                                                                                                    ...
                                                                                                    <option value="<?=$id_grado?>" <?=$grado['id_grado']==$asignacione['grado_id'] ? 'selected' : ''?>><?=$grado['curso']." - SECCIÓN - ".$grado['seccion'];?></option>
                                                                                                <?php
                                                                                                }
                                                                                                ?>
                                                                                            </select>
                                                            ...
                                                            <form action="<?=APP_URL;?>/app/controllers/docentes/delete_asignacion.php" onclick="preguntar<?=$id_asignacion;?>(event)" method="post" id="miformulario<?=$id_asignacion;?>">
                                                                <input type="text" name="id_asignacion" value="<?=$id_asignacion;?>" hidden>
                                                                <button type="submit" class="btn btn-danger btn-sm" style="border-radius: 0px 4px 4px 0px;"><i class="bi bi-trash"></i></button>
                                                                </form>
                                                                <script>
