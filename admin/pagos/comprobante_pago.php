...
$QR = 'Este recibo de pago es verificado por el sistema de pago de la Unidad Educativa '.$nombre_institucion.',
por el pago del mes de '.$mes_pagado.' la suma de Bs. '.$monto_pagado.' '.$fechaHora;
$pdf->write2DBarcode($QR, 'QRCODE,L',  170, 55, 30, 30, $style);

$QR2 = 'Este recibo de pago es verificado por el sistema de pago de la Unidad Educativa '.$nombre_institucion.',
por el pago del mes de '.$mes_pagado.' la suma de Bs. '.$monto_pagado.' '.$fechaHora;
$pdf->write2DBarcode($QR2, 'QRCODE,L',  170, 190, 30, 30, $style);
...
<tr>
    ...
    <td style="text-align: center"><h2><b><u>RECIBO DE PAGO</u></b></h2></td>
...
<tr>
    <td width="170px"><b>Cédula de identidad: </b></td>
    <td>'.$ci.'</td>
</tr>
<tr>
    <td width="170px"><b>Nivel: </b></td>
    <td>'.$nivel.' - Turno: '.$turno.'</td>
</tr>
<tr>
    <td width="170px"><b>Grado: </b></td>
    <td>'.$curso.' - Sección: '.$seccion.'</td>
</tr>
<tr>
