                  ...
                  <tr style="text-align: center;">
                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="contrato.php?id=<?=$id_estudiante;?>" type="button" class="btn btn-warning btn-sm"><i
                            class="bi bi-printer"></i></a>
                        <a href="create.php?id=<?=$id_estudiante;?>" type="button" class="btn btn-success btn-sm"><i
