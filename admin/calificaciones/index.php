                  ...
                  <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><center><a type="button" href="create.php?id_grado=<?=$id_grado;?>&&id_docente=<?=$asignacione['docente_id'];?>&&id_materia=<?=$asignacione['materia_id'];?>"
                             class="bnt btn-primary btn-sm"><i class="bi bi-check2-square"></i>
                              Cargar notas</a></center>
                            </td>
                        </tr>
                        <?php
                        }    
