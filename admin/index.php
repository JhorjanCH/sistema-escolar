        ...
        <div class="col-md-3 col-sm-6 col-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <a href="<?=APP_URL;?>admin/kardex/reporte_estudiante.php?id_estudiante=<?=$id_estudiante;?>"
        ...
        <div class="col-md-3 col-sm-6 col-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <a href="<?=APP_URL;?>admin/calificaciones/reporte_estudiante.php?id_estudiante=<?=$id_estudiante;?>"
          ...
          <div class="card card-outline card-primary">
            ...
            <div class="card-body">
              <input type="text" class="knob" value="<?=$contador_estudiantes;?>" data-min="0" data-max="200"
                data-readonly="true" data-thickness="0.1" data-width="100" data-height="100" data-fgColor="#fe2f02"
                disabled>
            </div>
          </div>
        </div>
          ...
          <div class="card card-outline card-primary">
            ...
            <div class="card-body">
              <input type="text" class="knob" value="<?=$contador_docentes;?>" data-min="0" data-max="30"
                data-readonly="true" data-thickness="0.1" data-width="100" data-height="100" data-fgColor="#021dfe"
                disabled>
            </div>
          </div>
        </div>
          ...
          <div class="card card-outline card-primary">
            ...
            <div class="card-body">
              <input type="text" class="knob" value="<?=$contador_administrativos;?>" data-min="0" data-max="30"
                data-readonly="true" data-thickness="0.1" data-width="100" data-height="100" data-fgColor="#19fe02"
                disabled>
            </div>
          </div>
        </div>
          ...
          <div class="card card-outline card-primary">
            ...
            <div class="card-body">
              <input type="text" class="knob" value="<?=$contador_usuarios;?>" data-min="0" data-max="500"
                data-readonly="true" data-thickness="0.1" data-width="100" data-height="100" data-fgColor="#fe02fe"
                disabled>
            </div>
          </div>
        </div>
  ...
  $('.knob').knob({
    draw: function() {
      if (this.$.data('skin') == 'tron') {
        ...
        this.g.arc(this.xy, this.xy, this.radius - this.lineWidth + 1 + this.lineWidth * 2 / 3, 0, 2 * Math
          .PI, false)
        this.g.stroke()
