          ...
          <div class="card card-outline card-primary">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="create_permisos.php" class="btn btn-primary"><i class="bi bi-plus-square"></i> Crear nuevo
                  permiso</a>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td style="text-align: center">
                      <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="edit_permiso.php?id=<?=$id_permiso;?>" type="button" class="btn btn-success btn-sm"><i
                            class="bi bi-pencil"></i></a>
                        <form action="<?=APP_URL;?>/app/controllers/roles/delete_permiso.php"
                          onclick="preguntar<?=$id_permiso;?>(event)" method="post" id="miformulario<?=$id_permiso;?>">
...
$(function() {
  $("#example1").DataTable({
    ...
    "language": {
      ...
      "infoPostFix": "",
      "thousands": ",",
      "lengthMenu": "Mostra _MENU_ Permisos",
