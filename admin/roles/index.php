                  ...
                  foreach ($roles as $role){
                      ...
                      <tr>
                        ...
                        <!-- Button trigger modal -->
                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#moda_asignacion<?=$id_rol;?>">
                              <i class="bi bi-check-circle"></i>
                            </button>
                        <!-- Modal -->
                            <div class="modal fade" id="moda_asignacion<?=$id_rol;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
