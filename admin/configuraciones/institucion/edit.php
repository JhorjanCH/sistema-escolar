      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-success">
            ...
            <div class="card-body">
              <form action="<?=APP_URL;?>/app/controllers/configuraciones/institucion/update.php" method="post"
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="nombre_institucion" value="<?=$nombre_institucion;?>"
    ...
    reader.onload = (function(theFile) {
      return function(e) {
        ...
        document.getElementById("list").innerHTML = ['<img class="thumb thumbnail" src="', e.target.result,
          '" width="200px" title="', escape(theFile.name), '"/>'
        ].join('');
      };
    })(f);
